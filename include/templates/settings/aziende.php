                        ...
                        <div class="col-md-12">
                            <div class="card card-bordered card-preview">
                                <div class="card-inner">
                                    <div class="card-head">
                                        <h6 class="title">Aziende</h6>
                                        <a onClick="apriModal('Nuova Azienda','Gestione Azienda','setting/form_insertazienda','new')" class="btn btn-dim btn-warning right">Aggiungi <?php echo $h2; ?></a>
                                    </div>
                                    <div class="card-inner">
                                        <?php 
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li>
                                                                            <a style="cursor: pointer;" onClick="apriModal('Modifica Azienda','Gestione Azienda','setting/form_modazienda','<?php echo $v['id']; ?>')">
