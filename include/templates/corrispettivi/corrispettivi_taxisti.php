                ...
                <div class="row g-3">
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label" for="mese">Azienda / Taxista</label>
                            <div class="form-control-wrap">
                                <select class="form-select" id="taxista" name="taxista" data-search="on" data-ui="lg">
                                    <option value="">Seleziona Azienda / Taxista</option>
                                    <optgroup label="Aziende">
                                        <?php 
                                            foreach($aziende as $azienda){
                                                echo"<option value='A".$azienda['id_azienda']."'>".$azienda['nome_azienda']." (".$azienda['numero_tassisti'].")</option>";
                                            }
                                        ?>
                                    </optgroup>
                                    <optgroup label="Taxisti">
                                        <?php foreach($tassisti as $taxi): ?>
                                        <option value="T<?php echo $taxi['id']; ?>"><?php echo $taxi['Nome']." ".$taxi['Cognome']; if ($taxi['Dimissioni'] != "") echo " (".$taxi['Dimissioni'].")"; ?></option>
                                        <?php endforeach; ?>
                                    </optgroup>
                                </select>
                            </div>
            ...
            <div class="card card-bordered card-preview">
                <div class="card-inner">
                    ...
                    <ul class="list list-sm list-checked">
                        ...
                        <?php endif; ?>
                        <?php //modificare la ricerca per corrispettivi aggregati ?>
                        <?php if ($at === 'A'): // Mostra il tipo solo se si cercano i corrispettivi aggregati ?>
                                    ...
                                    <li>
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <ul class="link-list-opt no-bdr">
                                                    <li>
                                                        <a style="cursor: pointer;" onClick="apriModal('Dettaglio Corrispettivo','Gestione corrispettivi','corrispettivi/dettaglio_corrispettivo','<?php echo $v['data']."|".$_POST['taxista']; ?>','1')">
                                                            <em class="icon ni ni-shield-star"></em>
