            ...
            <div class="card card-bordered card-preview">
                <div class="card-inner">
                                                            ...
                                                            <ul class="link-list-opt no-bdr">
                                                                <li>
                                                                    <a style="cursor: pointer;"
                                                                        onClick="apriModal('Modifica Users','Gestione users','user/form_utente','<?php echo $v['id']; ?>')">
                                                                ...
                                                                <li>
                                                                    <a href="<?php echo $serp; ?>?action=delete&id=<?php echo $v['id']; ?>"
                                                                        onclick="return confermaNavigazione();">
                                                                        <em class="icon ni ni-shield-star"></em>
                                                                        <span>Cancella</span>
                                                                    </a>
                                                                </li>
                    ...
                    <div class="center card-footer" style="background-color: #fff; border-top:none; margin-top:1.5rem;">
                        <a onClick="apriModal('Nuovo User','Gestione utenti','user/form_utente','new')"
