               ...
               <div class="nk-content ">
                   <div class="nk-split nk-split-page nk-split-lg">
                       <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
                           ...
                           <div class="nk-block nk-block-middle nk-auth-body" style="margin-top: 15%;">
                               <div class="brand-logo pb-5">
                                   <a href="./index.php" class="logo-link">
                                       <img class="logo-light logo-img logo-img-lg" src="./images/napolifacility/napolifacility.jpg" 
                                        srcset="./images/napolifacility/napolifacility.jpg 2x" alt="logo" style="scale: 5; margin-left: 12em;">
                                       <img class="logo-dark logo-img logo-img-lg" src="./images/napolifacility/napolifacility.jpg" 
                                        srcset="./images/napolifacility/napolifacility.jpg 2x" alt="logo-dark" style="scale: 5; margin-left: 12em;">
                                   </a>
                               </div>
