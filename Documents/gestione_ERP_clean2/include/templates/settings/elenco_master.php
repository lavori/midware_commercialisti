        ...
        <div class="col-md-12">
            <div class="card card-bordered card-preview">
                ...
                <div class="card-inner">
                    <?php
                    $th = isset($master) && !empty($master) ? array_keys($master[0]) : array();
                    ?>
                                                        ...
                                                        <ul class="link-list-opt no-bdr">
                                                            <li>
                                                                <a style="cursor: pointer;"
                                                                    onClick="apriModal('Visualizza Esami Master','Gestione Master','setting/visualizzaEsamiMaster','<?php echo $v['id']; ?>')">
                                                                    <em class="icon ni ni-shield-star"></em>
                                                                    <span>Visualizza Esami</span>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a style="cursor: pointer;" onClick="apriModal('Visualizza Esami Master','Gestione Master','setting/form_master','<?php echo $v['id']; ?>')">
                                                                    <em class="icon ni ni-shield-star"></em>
                                                                    <span>Modifica</span>
                                                                </a>
                                                            </li>
                    ...
                    <div class="center card-footer" style="background-color: #fff; border-top:none;">
                        <a style="cursor: pointer;" onClick="apriModal('Nuovo Master','Gestione Master','setting/form_master')" class="btn btn-primary">
                            Aggiungi Master</a>
                    </div>
                </div>
            </div>
