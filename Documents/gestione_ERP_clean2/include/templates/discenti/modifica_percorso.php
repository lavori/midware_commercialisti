                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <select class="form-select" id="annoAccessoDiscente" name="annoAccessoDiscente"
                                    ...
                                    <option value="" disabled <?= $controllo[0]['carriera']['annoAccessoDiscente'] === '' ? 'selected' : '' ?>>Seleziona...
                                    </option>
                                    <?php for ($i = 1; $i <= 5; $i++): ?>
                                        <option value="<?= $i ?>" <?= ($controllo[0]['carriera']['annoAccessoDiscente'] == $i) ? 'selected' : '' ?>><?= $i ?>
                                        </option>
                                    <?php endfor; ?>
                                </select>
                            </div>
