            ...
            <div class="card card-bordered card-preview">
                ...
                <div class="card-inner">
                    ...
                    <div class="form-group">
                        <div class="gy-3">
                            <?php if (!empty($esami) && isset($esami[0]['esami'])):
                                $TE = ''; ?>
                                <?php foreach ($esami[0]['esami'] as $exam): ?>
                                    <?php
                                    /*
                                    echo '<pre>';
                                    print_r($exam);
                                    ...
                                    <div class="row g-3 align-center mb-3 border-bottom pb-3">
                                        <!-- Titolo -->
                                        <div class="col-lg-12">
                                            <h5 class="title"><?php echo htmlspecialchars($exam['nome']); ?></h5>
                                        </div>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <div class="input-group">
                                                        <?php if (isset($exam['data_scritto']) && empty($exam['data_scritto']) && empty($exam['voto'])) { ?>
                                                            <a onClick="apriModal('Fissa Data Scritto','Gestione Esame','scadenzaEsami/form_data','<?php echo $exam['id'] . '|' . 'scritto'; ?>')"
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <div class="input-group">
                                                        <?php if (empty($exam['voto']) && !empty($exam['data_scritto'])) { ?>
                                                            <?php if (isset($exam['data_orale']) && empty($exam['data_orale'])) { ?>
                                                                <a onClick="apriModal('Fissa Data Orale','Gestione Esame','scadenzaEsami/form_data','<?php echo $exam['id'] . '|orale|' . $exam['data_scritto']; ?>')"
                                                                    class="btn btn-primary">Fissa</a>
                                                            <?php } else { ?>
                                                                <label class="form-label mb-0 ms-3">
                                                                    <?php
                                                            ...
                                                            <?php } ?>
                                                        <?php } elseif (!empty($exam['data_orale'])) { ?>
                                                            <label class="form-label mb-0 ms-3">
                                                                <?php
                                                                echo substr($exam['data_orale'], 0, -3);
                                                                $TE = 'O';
                                        ...
                                        <?php if (isset($exam['data_scritto']) && !empty($exam['data_scritto'])) { ?>
                                            <?php if (!isset($exam['voto']) || empty($exam['voto'])) { ?>
                                                <div class="col-lg-4 d-flex align-items-center">
                                                    <a onClick="apriModal('Modifica','Gestione Esame','scadenzaEsami/modificaEsame','<?php echo $exam['id'] . '|' . $exam['data_scritto'] . '|' . $exam['data_orale'] . '|' . $TE; ?>')"
                                                        class="btn btn-primary me-2">Modifica</a>
                                                    <a onClick="apriModal('Inserisci Voto','Gestione Esame','scadenzaEsami/insertVoto','<?php echo $exam['id'] ?>')"
                                        ...
                                        <div class="col-lg-3 d-flex align-items-center">
                                            ...
                                            <label class="form-label mb-0 ms-3">
                                                Data:
                                                <?php echo !empty($exam['dataVoto']) ? $exam['dataVoto'] : 'Non Inserito'; ?>
                                            </label>
                                        </div>
                                    </div>
                                    <div><br></div>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <p>Nessun esame assegnato a questo discente.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
