                ...
                <div class="card-inner">
                    <div class="form-group">
                        <div class="card-head">
                            <h4 class="card-title">
                                Discente:
                                <?= htmlspecialchars($datiDiscente['nome'] . ' ' . $datiDiscente['cognome']) ?>
                            </h4>
                        </div>
                        <div class="card-head">
                            <h6 class="card-title">
                                N. Matricola:
                                <?= isset($datiDiscente['numMatricola']) ? htmlspecialchars($datiDiscente['numMatricola']) : '' ?>
                            </h6>
                        </div>
                    </div>
                                    ...
                                    <?php foreach ($pD as $col => $val): ?>
                                        ...
                                        <td>
                                            ...
                                            if (
                                                ...
                                                echo '<a href="' . $val . '" type="button" class="btn btn-primary" target="_blank">Modifica</a>';
                                                // Altri valori
                                            } elseif ($val !== '') {
                                                echo $val;
                                            }
