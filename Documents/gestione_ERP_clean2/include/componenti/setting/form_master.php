...
if (isset($_POST['id']) && $_POST['id'] != '') {
    ...
    $query = "SELECT * FROM `an_master` WHERE `id` = $id";
...
<form id="form_corso" class="form-validate is-alter" method="POST">
    ...
    <div class="form-group">
        <label class="form-label" for="master">Nome Master</label>
        <div class="form-control-wrap">
            <input type="text" class="form-control" id="master" name="master" required <?php if ($azione == 'update') { ?>
                    value="<?php echo $corso['nome']; ?>" <?php } ?>>
        </div>
    </div>
    <div class="form-group">
