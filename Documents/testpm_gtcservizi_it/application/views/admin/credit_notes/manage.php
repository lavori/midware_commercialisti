            ...
            <div class="col-md-12">
                <div class="tw-mb-2">
                    <div class="_buttons sm:tw-space-x-1 rtl:sm:tw-space-x-reverse">
                        ...
                        <a href="#"
                            data-toggle="modal"
                            data-target="#credit-notes-import-xml-modal"
                            title="<?= _l('import_xml_credit_notes'); ?>"
                            class="btn-with-tooltip pull-left btn btn-default !tw-px-3">
...
<?php if (staff_can('create', 'credit_notes')) { ?>
<div class="modal fade" id="credit-notes-import-xml-modal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= _l('import_xml_credit_notes'); ?></h4>
            </div>
            <?= form_open_multipart(admin_url('credit_notes/import_xml'), ['id' => 'credit-notes-import-xml-form']); ?>
            <div class="modal-body">
                <div class="form-group">
                    <label class="control-label"><?= _l('select_xml_files'); ?></label>
                    <input type="file" name="xml_files[]" multiple accept=".xml" class="form-control">
                    <p class="help-block"><?= _l('import_xml_hint'); ?></p>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><?= _l('close'); ?></button>
                <button type="submit" class="btn btn-primary"><?= _l('import'); ?></button>
            </div>
            <?= form_close(); ?>
        </div>
    </div>
