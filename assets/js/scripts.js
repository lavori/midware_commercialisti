  ...
  NioApp.DataTable = function (elm, opt) {
    if ($(elm).exists()) {
      $(elm).each(function () {
        ...
        var export_title = $(this).data('export-title') ? $(this).data('export-title') : 'Esporta';
        ...
        var def = {
            ...
            language: {
              ...
              lengthMenu: "<span class='d-none d-sm-inline-block'>Mostra</span><div class='form-control-select'> _MENU_ </div>",
